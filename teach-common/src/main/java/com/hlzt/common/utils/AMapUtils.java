...
public class AMapUtils {
     ...
     * @param endLongitude 经度
     * @param endLatitude 纬度
     * @return
     */
    public static double calculateLineDistance(double startLongitude, double startLatitude, double endLongitude, double endLatitude) {
    ...
    public static void main(String[] args) {
        System.out.println(calculateLineDistance(116.368904,39.923423,116.387271,39.922501));
    }
}
